...
/**
 * Footer Component
 * Site footer with navigation links, legal info, and social links
 */
function Footer() {
  const currentYear = new Date().getFullYear();

  return (
    <footer className="bg-gray-900 dark:bg-black text-gray-300 py-12" role="contentinfo">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-sm text-gray-400 max-w-md">
              The modern LinkedIn prospecting tool for recruiters, sales teams,
              and growth professionals.
            </p>
          </div>
